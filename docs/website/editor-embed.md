...
Only parameters that would be helpful here are ?showprojectpage, which shows the "See Project Page" button and ?projectpage which will tap that button even if it is hidden.
