...
CattyMod also supports unsandboxed extensions which add new blocks either from trusted URLs (https://extensions.turbowarp.org/ or https://cattymod.app/extensions/), JS Files or Text.
